...
export const PromptSchema = z.object({
    ...
    input: JSONSchema.describe('JSON Schema defining the structure of the input expected by the prompt'),
    output: JSONSchema.describe('JSON Schema defining the structure of the output produced by the prompt'),
});
