...
export interface IPromptModelStatic {
	...
	listPrompts(
		category?: string,
		fileSystem?: IPromptFileSystem,
	): Promise<Array<{ name: string; category: string; filePath: string }>>;
	deletePrompt(
		category: string,
		name: string,
		fileSystem?: IPromptFileSystem,
...
interface IPromptCategory<
	T extends Record<string, IPrompt<IPromptInput, IPromptOutput>>,
> {
	[K: string]: {
...
> {
	...
	categories: {
		[category: string]: IPromptCategory<
			Record<string, IPrompt<IPromptInput, IPromptOutput>>
		>;
	};
...
interface IPromptFileSystem {
	 ...
	 */
	loadPrompt(props: { category: string; promptName: string }): Promise<
		IPrompt<IPromptInput, IPromptOutput>
	>;
	 ...
	 */
	getPromptVersions(props: { category: string; promptName: string }): Promise<
		string[]
	>;
